TGraphErrors * GetVNPt( int replay, int bin, int epindx,  double etamin, double etamax, TGraphErrors * &gA, TGraphErrors * &gB, TGraphErrors * &gspec,  double & vint, double & vinte, double & vintA, double & vintAe, double & vintB, double & vintBe, bool nonorm = false ){
    ...
    bool mixflip = false;
    if (strip == "N112SUB2" || strip == "N112SUB3" || strip == "N112ASUB2" || strip == "N112ASUB3" || strip == "N112BSUB2" || strip == "N112BSUB3") mixflip = true;
    bool sub2 = false;
    ...
    int ietamax2 = 0;
    double sign = 1.;
    // if (replay == "N112SUB2" || replay == "N112SUB3" || replay == "N112ASUB2" || replay == "N112ASUB3") sign=-1.;
    if (etamin*etamax<0) {
