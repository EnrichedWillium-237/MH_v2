...
/*
    ...
    legComparepmMC18->AddEntry(gN1MCm18SUB2[setcent],"N1MCm18SUB2 (-2.0 < #eta < -1.6)","p");
    legComparepmMC18->AddEntry(gN1MCp18SUB2[setcent],"N1MCp18SUB2 (1.6 < #eta < 2.0)","p");
    ...
    hComparepmMC10->Draw();
    gN1MCm10SUB2[setcent]->Draw("same");
    gN1MCp10SUB2[setcent]->Draw("same");
    TLegend * legComparepmMC10 = new TLegend(0.48, 0.82, 0.78, 0.93);
    SetLegend(legComparepmMC10, 18);
    legComparepmMC10->AddEntry(gN1MCm10SUB2[setcent],"N1MCm10SUB2 (-1.2 < #eta < -0.8)","p");
    legComparepmMC10->AddEntry(gN1MCp10SUB2[setcent],"N1MCp10SUB2 (0.8 < #eta < 1.2)","p");
    ...
    hComparepmMC06->Draw();
    gN1MCm06SUB2[setcent]->Draw("same");
    gN1MCp06SUB2[setcent]->Draw("same");
    TLegend * legComparepmMC06 = new TLegend(0.48, 0.82, 0.78, 0.93);
    SetLegend(legComparepmMC06, 18);
    legComparepmMC06->AddEntry(gN1MCm06SUB2[setcent],"N1MCm06SUB2 (-0.8 < #eta < -0.4)","p");
    legComparepmMC06->AddEntry(gN1MCp06SUB2[setcent],"N1MCp06SUB2 (0.4 < #eta < 0.8)","p");
    ...
    hComparepmMC02->Draw();
    gN1MCm02SUB2[setcent]->Draw("same");
    gN1MCp02SUB2[setcent]->Draw("same");
    TLegend * legComparepmMC02 = new TLegend(0.48, 0.82, 0.78, 0.93);
    SetLegend(legComparepmMC02, 18);
    legComparepmMC02->AddEntry(gN1MCm02SUB2[setcent],"N1MCm02SUB2 (-0.4 < #eta < 0.0)","p");
    legComparepmMC02->AddEntry(gN1MCp02SUB2[setcent],"N1MCp02SUB2 (0.0 < #eta < 0.4)","p");
