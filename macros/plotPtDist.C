...
void plotPtDist()
{
    ...
    for (int cbin = 0; cbin<ncentbins; cbin++) {
        ...
        txN1MCpm22SUB2->Draw();
        cN1MCpm22SUB2->Print(Form("results/Pt_Distributions/N1MCpm22SUB2_%d_%d.png",cminCENT[cbin],cmaxCENT[cbin]),"png");
        cN1MCpm22SUB2->Close();
        ...
        cratN1MCpm22SUB2->Print(Form("results/Pt_Distributions/N1MCpm22SUB2_ratio_%d_%d.png",cminCENT[cbin],cmaxCENT[cbin]),"png");
        ...
        txN1MCpm22SUB3->Draw();
        cN1MCpm22SUB3->Print(Form("results/Pt_Distributions/N1MCpm22SUB3_%d_%d.png",cminCENT[cbin],cmaxCENT[cbin]),"png");
        cN1MCpm22SUB3->Close();
        ...
        cratN1MCpm22SUB3->Print(Form("results/Pt_Distributions/N1MCpm22SUB3_ratio_%d_%d.png",cminCENT[cbin],cmaxCENT[cbin]),"png");
